...
import 'package:trekkers/screens/user-participated-events/user_participated_events_tile.dart';
...
class UserParticipatedEventsScreen extends StatefulWidget {
  const UserParticipatedEventsScreen({Key key, @required this.id}) : super(key: key);
  final id;
  @override
