...
List<Future<List<VertexMesh>>> preloadedMeshes = [];
List<List<InstanceInfo>> preloadInstanceInfos = [];
...
class _Indie3dHomeState extends State<Indie3dHome>
  ...
  // RandomVertexController _controller;
  int _pageIndex = 0;
  ...
  void initState() {
    ...
    preloadedMeshes.add(loadVertexMeshesFromOBJAssets(context, [
      ObjPath('torus', "${App.bundle}/assets", 'torus.obj'),
    ]));
    preloadInstanceInfos.add(
      [
        InstanceInfo('torus',scale: vec32.Vector3(0.5,0.5,0.5)),
        InstanceInfo('torus',scale: vec32.Vector3(0.5,0.5,0.5)),
        InstanceInfo('torus',scale: vec32.Vector3(0.5,0.5,0.5)),
        InstanceInfo('torus',scale: vec32.Vector3(0.5,0.5,0.5)),
        InstanceInfo('torus',scale: vec32.Vector3(0.5,0.5,0.5)),
    ...
    preloadedMeshes.add(loadVertexMeshesFromOBJAssets(
        context, [ObjPath('cube', "${App.bundle}/assets", 'cube.obj')]));
  ...
  //   _controller.triggerTap(context, details.localPosition);
  // }
