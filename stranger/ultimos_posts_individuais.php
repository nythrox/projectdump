...
$sql = "select titulo_post, data_post, conteudo_post, likes_post, apelido_post, nome, imagem, tipo from post inner join autor on post.id_autor = autor.id_autor where autor.id_autor = ".$_SESSION['id_autor'];
...
<?php
    ...
    echo"<h1>Não há posts recentes</h1>";
}
?>