...
import 'package:goodstart_app/widgets/ContentExercise/bloc/TextCheckboxFourBloc.dart';
import 'package:goodstart_app/widgets/Exercises/CheckboxFourWidget.dart';

class TextCheckboxFourWidget extends StatefulWidget {
  ...
  TextCheckboxFourWidget(
      this.content, this.answer, this.title, this.subtitle, this.options,
      {this.link, this.controller, this.isLastChild});

  @override
  _TextCheckboxFourWidgetState createState() => _TextCheckboxFourWidgetState();
}

class _TextCheckboxFourWidgetState extends State<TextCheckboxFourWidget> {
  TextCheckboxFourBloc bloc;
  @override
  void initState() {
    bloc = new TextCheckboxFourBloc(widget.answer);
    super.initState();
  }
