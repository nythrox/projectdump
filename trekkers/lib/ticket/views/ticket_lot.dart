...
class TicketLot extends StatelessWidget {
  const TicketLot({Key key, this.dataInicioVendas}) : super(key: key);
  final String dataInicioVendas;

  @override
  Widget build(BuildContext context) {
    bool colorState = dataInicioVendas != null;
    return Column(
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                child: Text(
                  !colorState ? "VENDAS ENCERRADAS" : dataInicioVendas,
                  textScaleFactor: 1.2,
                  maxLines: 2,
                  softWrap: true,
