  ...
  Widget menu() {
    return Padding(
      ...
      child: ListView(
        children: <Widget>[
          profile(),
          menuItem('Amigos', 'Encontre amigos na Comunidade', '/eventos'),
          menuItem('Medalhas', 'Visualize nosso mural de medalhas', '/eventos'),
          menuItem('Ingressos', 'Encontre seus ingressos', '/eventos'),
          menuItem('Estatisticas', 'Visualize suas estatisticas', '/eventos'),
