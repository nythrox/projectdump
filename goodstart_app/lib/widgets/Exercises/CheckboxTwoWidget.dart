...
class CheckboxTwoWidget extends StatefulWidget {
  final List<String> options;

  CheckboxTwoWidget({Key key, this.options}) : super(key: key);

  @override
  createState() {
    return new CheckboxTwoWidgetState();
  }
}

class CheckboxTwoWidgetState extends State<CheckboxTwoWidget> {
