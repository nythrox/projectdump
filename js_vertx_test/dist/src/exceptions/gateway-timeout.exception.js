...
class GatewayTimeoutException extends http_exception_1.HttpException {
    ...
    constructor(message, error = 'Gateway Timeout') {
        super(http_exception_1.HttpException.createBody(message, error, http_status_enum_1.HttpStatus.GATEWAY_TIMEOUT), http_status_enum_1.HttpStatus.GATEWAY_TIMEOUT);
    }
}
