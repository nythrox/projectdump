...
import 'package:goodstart_app/widgets/ContentExercise/bloc/TextCheckboxOneBloc.dart';
import 'package:goodstart_app/widgets/Exercises/CheckboxOneWidget.dart';

class TextCheckboxOneWidget extends StatefulWidget {
  ...
  @override
  _TextCheckboxOneWidgetState createState() => _TextCheckboxOneWidgetState();
}

class _TextCheckboxOneWidgetState extends State<TextCheckboxOneWidget> {
  TextCheckboxOneBloc bloc;
  @override
  void initState() {
    bloc = new TextCheckboxOneBloc(widget.answer);
    super.initState();
  }
        ...
        children: <Widget>[
          ListView(
            children: <Widget>[
              ...
              //CheckboxOneExerciseWidget(answer, title, subtitle, options),
              CheckboxOneWidget(
